...
16 chapters plus overview and four FAQ. Pitch facts: PH 2.0, XH 2.5, SH 1.0, ZH 1.5, GH 1.25, VH 3.96 mm. SM wire-to-wire 2.5 mm. JWPF IPX7 is conditional and not high-pressure wash or permanent immersion. No universal battery polarity, certification or automotive/medical suitability claims.

Images follow approved copy: 18 unique licensed real references needed. Compact precision-electronics editorial direction: fine rules, restrained steel-gray accents, narrow photographs, paired related explanations and full-width technical passages; no box walls. No repeated photo source across earlier pages. All paragraphs retain 2em indent; edge-aligned images and fixed navigation.
