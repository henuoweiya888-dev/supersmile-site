...
async function loadData(){
  ...
  const [s,p,series,capabilities,categoryDetails] = await Promise.all([
    ...
    fetch('/data/product-category-details.json?v=20260910v26').then(r=>r.json())
  ]);
...
function renderProductCategoryRichMarkup(page,item){
  ...
  if(page.layout==='technical-editorial'){
    ...
    const aiNotice=page.hasAiImages?(LANG==='zh'?' 标注为 AI 示意的图片不是实拍或尺寸依据。':' Images labeled AI illustration are not photographs or dimensional references.'):'';
  ...
  if(page.layout==='dsub-blueprint'){
    const blueprintImage=(src,alt,className='')=>`<figure class="pcc-dsub-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1200" height="900" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-dsub-chapter pcc-dsub-chapter-${index%3+1}"><div class="pcc-dsub-label"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p></div>${blueprintImage(chapter.image,t(chapter.title))}<div class="pcc-dsub-copy"><h2>${htmlEscape(t(chapter.title))}</h2><p class="pcc-dsub-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-dsub-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div></article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
    return `<section class="pcc-dsub-opening"><div class="pcc-dsub-opening-copy"><span>INTERFACE DOSSIER</span><h2>${heading('introduction')}</h2><p>${htmlEscape(t(page.lead))}</p></div>${blueprintImage(page.images.range,`${item} ${LANG==='zh'?'产品系列':'product family'}`,'pcc-dsub-opening-media')}</section><section class="pcc-dsub-sequence">${chapters}</section><section class="pcc-rich-section pcc-rich-faq pcc-dsub-faq"><header class="pcc-rich-heading"><h2>${heading('faq')}</h2></header><div class="pcc-faq-grid">${faq}</div></section><details class="pcc-media-credits"><summary>${htmlEscape(t(page.creditHeading))}</summary><ul>${credits}</ul></details>`;
  }
  if(page.layout==='usb-signal-flow'){
    const flowImage=(src,alt,className='')=>`<figure class="pcc-usb-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1200" height="900" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-usb-chapter pcc-usb-chapter-${index%4+1}"><div class="pcc-usb-meta"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p></div>${flowImage(chapter.image,t(chapter.title))}<div class="pcc-usb-copy"><h2>${htmlEscape(t(chapter.title))}</h2><p class="pcc-usb-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-usb-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div></article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
    return `<section class="pcc-usb-opening"><div class="pcc-usb-opening-copy"><span>SIGNAL / POWER / MECHANICS</span><h2>${heading('introduction')}</h2><p>${htmlEscape(t(page.lead))}</p></div>${flowImage(page.images.range,`${item} ${LANG==='zh'?'接口家族':'interface family'}`,'pcc-usb-opening-media')}</section><section class="pcc-usb-sequence">${chapters}</section><section class="pcc-rich-section pcc-rich-faq pcc-usb-faq"><header class="pcc-rich-heading"><h2>${heading('faq')}</h2></header><div class="pcc-faq-grid">${faq}</div></section><details class="pcc-media-credits"><summary>${htmlEscape(t(page.creditHeading))}</summary><ul>${credits}</ul></details>`;
  }
  if(page.layout==='audio-signal-chain'){
    const audioImage=(src,alt,className='')=>`<figure class="pcc-audio-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1200" height="900" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-audio-chapter pcc-audio-chapter-${index%4+1}"><div class="pcc-audio-meta"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p></div>${audioImage(chapter.image,t(chapter.title))}<div class="pcc-audio-copy"><h2>${htmlEscape(t(chapter.title))}</h2><p class="pcc-audio-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-audio-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div></article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
    return `<section class="pcc-audio-opening"><div class="pcc-audio-opening-copy"><span>FROM SOURCE TO LISTENER</span><h2>${heading('introduction')}</h2><p>${htmlEscape(t(page.lead))}</p></div>${audioImage(page.images.range,`${item} ${LANG==='zh'?'信号路径':'signal path'}`,'pcc-audio-opening-media')}</section><section class="pcc-audio-sequence">${chapters}</section><section class="pcc-rich-section pcc-rich-faq pcc-audio-faq"><header class="pcc-rich-heading"><h2>${heading('faq')}</h2></header><div class="pcc-faq-grid">${faq}</div></section><details class="pcc-media-credits"><summary>${htmlEscape(t(page.creditHeading))}</summary><ul>${credits}</ul></details>`;
  }
  if(page.layout==='video-frame-line'){
    const frameImage=(src,alt,className='')=>`<figure class="pcc-video-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1200" height="900" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-video-chapter pcc-video-chapter-${index%5+1}"><div class="pcc-video-index"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p></div><div class="pcc-video-copy"><h2>${htmlEscape(t(chapter.title))}</h2><p class="pcc-video-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-video-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div>${frameImage(chapter.image,t(chapter.title))}</article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
    return `<section class="pcc-video-opening">${frameImage(page.images.range,`${item} ${LANG==='zh'?'视频链路':'video link'}`,'pcc-video-opening-media')}<div class="pcc-video-opening-copy"><span>SOURCE / LINK / DISPLAY</span><h2>${heading('introduction')}</h2><p>${htmlEscape(t(page.lead))}</p></div></section><section class="pcc-video-sequence">${chapters}</section><section class="pcc-rich-section pcc-rich-faq pcc-video-faq"><header class="pcc-rich-heading"><h2>${heading('faq')}</h2></header><div class="pcc-faq-grid">${faq}</div></section><details class="pcc-media-credits"><summary>${htmlEscape(t(page.creditHeading))}</summary><ul>${credits}</ul></details>`;
  }
  if(page.layout==='power-load-path'){
    const powerImage=(src,alt,className='')=>`<figure class="pcc-power-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1200" height="900" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-power-chapter pcc-power-chapter-${index%4+1}"><div class="pcc-power-rail"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p></div>${powerImage(chapter.image,t(chapter.title))}<div class="pcc-power-copy"><h2>${htmlEscape(t(chapter.title))}</h2><p class="pcc-power-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-power-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div></article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
    return `<section class="pcc-power-opening"><div class="pcc-power-opening-copy"><span>SOURCE / LOAD / PROTECTION</span><h2>${heading('introduction')}</h2><p>${htmlEscape(t(page.lead))}</p></div>${powerImage(page.images.range,`${item} ${LANG==='zh'?'供电路径':'power path'}`,'pcc-power-opening-media')}</section><section class="pcc-power-sequence">${chapters}</section><section class="pcc-rich-section pcc-rich-faq pcc-power-faq"><header class="pcc-rich-heading"><h2>${heading('faq')}</h2></header><div class="pcc-faq-grid">${faq}</div></section><details class="pcc-media-credits"><summary>${htmlEscape(t(page.creditHeading))}</summary><ul>${credits}</ul></details>`;
  }
  if(page.layout==='battery-terminal-map'){
    const batteryImage=(src,alt,className='')=>`<figure class="pcc-battery-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1200" height="900" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-battery-chapter pcc-battery-chapter-${index%5+1}"><div class="pcc-battery-meta"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p></div>${batteryImage(chapter.image,t(chapter.title))}<div class="pcc-battery-copy"><h2>${htmlEscape(t(chapter.title))}</h2><p class="pcc-battery-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-battery-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div></article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
  ...
  if(page.layout==='lvds-signal-map'){
    const lvdsImage=(src,alt,className='')=>`<figure class="pcc-lvds-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1200" height="900" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-lvds-chapter pcc-lvds-chapter-${index%4+1}"><header class="pcc-lvds-heading"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p><h2>${htmlEscape(t(chapter.title))}</h2></header>${lvdsImage(chapter.image,t(chapter.title))}<div class="pcc-lvds-copy"><p class="pcc-lvds-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-lvds-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div></article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
    return `<section class="pcc-lvds-opening">${lvdsImage(page.images.range,`${item} ${LANG==='zh'?'显示系统':'display system'}`,'pcc-lvds-opening-media')}<div class="pcc-lvds-opening-copy"><span>SOURCE</span><i></i><span>PAIR</span><i></i><span>RECEIVER</span><h2>${heading('introduction')}</h2><p>${htmlEscape(t(page.lead))}</p></div></section><section class="pcc-lvds-sequence">${chapters}</section><section class="pcc-rich-section pcc-rich-faq pcc-lvds-faq"><header class="pcc-rich-heading"><h2>${heading('faq')}</h2></header><div class="pcc-faq-grid">${faq}</div></section><details class="pcc-media-credits"><summary>${htmlEscape(t(page.creditHeading))}</summary><ul>${credits}</ul></details>`;
  }
  if(page.layout==='rf-frequency-ledger'){
    const rfImage=(src,alt,className='')=>`<figure class="pcc-rf-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1400" height="960" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-rf-chapter pcc-rf-chapter-${index+1}"><header class="pcc-rf-heading"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p><h2>${htmlEscape(t(chapter.title))}</h2></header>${rfImage(chapter.image,t(chapter.title))}<div class="pcc-rf-copy"><p class="pcc-rf-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-rf-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div></article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
  ...
  if(page.layout==='military-field-dossier'){
    const fieldImage=(src,alt,className='')=>`<figure class="pcc-field-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1400" height="960" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-field-chapter pcc-field-chapter-${index+1}"><div class="pcc-field-meta"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p></div><header class="pcc-field-heading"><h2>${htmlEscape(t(chapter.title))}</h2></header>${fieldImage(chapter.image,t(chapter.title))}<div class="pcc-field-copy"><p class="pcc-field-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-field-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div></article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
    return `<section class="pcc-field-opening"><div class="pcc-field-opening-copy"><span>PLATFORM / INTERFACE / ENVIRONMENT / EVIDENCE</span><h2>${heading('introduction')}</h2><p>${htmlEscape(t(page.lead))}</p><div class="pcc-field-baseline"><b>${LANG==='zh'?'需求':'REQUIREMENT'}</b><i></i><b>${LANG==='zh'?'配置':'CONFIGURATION'}</b><i></i><b>${LANG==='zh'?'验收':'ACCEPTANCE'}</b></div></div>${fieldImage(page.images.range,`${item} ${LANG==='zh'?'加固连接细节':'rugged interconnect detail'}`,'pcc-field-opening-media')}</section><section class="pcc-field-dossier">${chapters}</section><section class="pcc-rich-section pcc-rich-faq pcc-field-faq"><header class="pcc-rich-heading"><h2>${heading('faq')}</h2></header><div class="pcc-faq-grid">${faq}</div></section><details class="pcc-media-credits"><summary>${htmlEscape(t(page.creditHeading))}</summary><ul>${credits}</ul></details>`;
  }
  if(page.layout==='diagnostic-signal-map'){
    const diagnosticImage=(src,alt,className='')=>`<figure class="pcc-diagnostic-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1400" height="960" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-diagnostic-chapter pcc-diagnostic-chapter-${index+1}"><div class="pcc-diagnostic-index"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p></div>${diagnosticImage(chapter.image,t(chapter.title))}<div class="pcc-diagnostic-copy"><h2>${htmlEscape(t(chapter.title))}</h2><p class="pcc-diagnostic-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-diagnostic-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div></article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
    return `<section class="pcc-diagnostic-opening">${diagnosticImage(page.images.range,`${item} ${LANG==='zh'?'车辆诊断接口':'vehicle diagnostic interface'}`,'pcc-diagnostic-opening-media')}<div class="pcc-diagnostic-opening-copy"><span>VEHICLE / INTERFACE / SIGNAL / TOOL</span><h2>${heading('introduction')}</h2><p>${htmlEscape(t(page.lead))}</p><div class="pcc-diagnostic-bus" aria-hidden="true"><b>16</b><i></i><b>CAN</b><i></i><b>K</b><i></i><b>VCI</b></div></div></section><section class="pcc-diagnostic-atlas">${chapters}</section><section class="pcc-rich-section pcc-rich-faq pcc-diagnostic-faq"><header class="pcc-rich-heading"><h2>${heading('faq')}</h2></header><div class="pcc-faq-grid">${faq}</div></section><details class="pcc-media-credits"><summary>${htmlEscape(t(page.creditHeading))}</summary><ul>${credits}</ul></details>`;
  }
  if(page.layout==='ecu-control-stack'){
    const ecuImage=(src,alt,className='')=>`<figure class="pcc-ecu-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1400" height="960" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-ecu-chapter pcc-ecu-chapter-${index+1}"><header class="pcc-ecu-heading"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p><h2>${htmlEscape(t(chapter.title))}</h2></header>${ecuImage(chapter.image,t(chapter.title))}<div class="pcc-ecu-copy"><p class="pcc-ecu-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-ecu-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div></article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
    return `<section class="pcc-ecu-opening"><div class="pcc-ecu-opening-copy"><span>CONTROLLER / CIRCUIT / LOAD / NETWORK</span><h2>${heading('introduction')}</h2><p>${htmlEscape(t(page.lead))}</p><div class="pcc-ecu-stack" aria-hidden="true"><b>ECU</b><i></i><b>${LANG==='zh'?'线束':'HARNESS'}</b><i></i><b>${LANG==='zh'?'负载':'LOADS'}</b><i></i><b>${LANG==='zh'?'网络':'BUS'}</b></div></div>${ecuImage(page.images.range,`${item} ${LANG==='zh'?'控制器接口':'controller interface'}`,'pcc-ecu-opening-media')}</section><section class="pcc-ecu-sequence">${chapters}</section><section class="pcc-rich-section pcc-rich-faq pcc-ecu-faq"><header class="pcc-rich-heading"><h2>${heading('faq')}</h2></header><div class="pcc-faq-grid">${faq}</div></section><details class="pcc-media-credits"><summary>${htmlEscape(t(page.creditHeading))}</summary><ul>${credits}</ul></details>`;
  }
  if(page.layout==='j1939-network-route'){
    const jImage=(src,alt,className='')=>`<figure class="pcc-j1939-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1400" height="960" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-j1939-chapter pcc-j1939-chapter-${index+1}"><div class="pcc-j1939-index"><span>${String(index+1).padStart(2,'0')}</span><i></i><small>${htmlEscape(t(chapter.kicker))}</small></div><div class="pcc-j1939-copy"><h2>${htmlEscape(t(chapter.title))}</h2><p class="pcc-j1939-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-j1939-notes">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div>${jImage(chapter.image,t(chapter.title))}</article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
  ...
  if(page.layout==='construction-motion-field'){
    const fieldImage=(src,alt,className='')=>`<figure class="pcc-construction-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1400" height="960" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-construction-chapter pcc-construction-chapter-${index+1}"><div class="pcc-construction-meta"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p></div><div class="pcc-construction-copy"><h2>${htmlEscape(t(chapter.title))}</h2><p class="pcc-construction-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-construction-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div>${fieldImage(chapter.image,t(chapter.title))}</article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
  ...
  if(page.layout==='relay-protection-editorial'){
    ...
    const chapters=page.chapters||[];
    const chapter=(i,kind)=>{const c=chapters[i],media=photo(c.image,t(c.caption||c.title),t(c.caption)),inset=['service','fuse','relay'].includes(kind);return `<article id="relay-topic-${i}" class="re-topic re-${kind}">${inset?media:''}<div class="re-copy"><h2>${htmlEscape(t(c.title))}</h2><p>${htmlEscape(t(c.copy))}</p></div>${inset?'':media}</article>`;};
    const jumpLabel=LANG==='zh'?'本页导读':'On this page';
    const jump=[0,2,6,8].map(i=>`<a href="#relay-topic-${i}">${htmlEscape(t(chapters[i].title))}</a>`).join('');
    const flow=(LANG==='zh'?['回路定义','物料确认','加工组装','检验放行']:['Circuit definition','Material approval','Harness assembly','Inspection & release']).map(s=>`<li>${s}</li>`).join('');
    const editorial=`${chapter(0,'range')}${chapter(1,'material')}<div class="re-context">${chapter(2,'solution')}${chapter(3,'application')}</div>${chapter(4,'safety')}${chapter(5,'service')}<div class="re-manufacture">${chapter(6,'process')}<ol class="re-flow" aria-label="${LANG==='zh'?'制造流程概览':'Manufacturing overview'}">${flow}</ol></div>${chapter(7,'environment')}<div class="re-reference">${chapter(8,'fuse')}${chapter(9,'relay')}</div>`;
    const faq=(page.faq||[]).map((e,i)=>`<details${i===0?' open':''}><summary>${htmlEscape(t(e.q))}</summary><p>${htmlEscape(t(e.a))}</p></details>`).join('');
    ...
    return `<div class="re-page"><section class="re-opening"><div class="re-intro"><h2>${heading('introduction')}</h2><p>${htmlEscape(t(page.lead))}</p><nav class="re-index" aria-label="${jumpLabel}">${jump}</nav></div>${photo(page.images.range,`${item} ${LANG==='zh'?'配电盒结构':'distribution box construction'}`)}</section>${editorial}<section class="pcc-rich-section pcc-rich-faq"><header class="pcc-rich-heading"><h2>${heading('faq')}</h2></header><div class="pcc-faq-grid">${faq}</div></section><details class="pcc-media-credits"><summary>${htmlEscape(t(page.creditHeading))}</summary><ul>${credits}</ul></details></div>`;
  }
  ...
  if(page.layout==='lighting-optical-circuit'){
    ...
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-lighting-chapter pcc-lighting-chapter-${index+1}"><div class="pcc-lighting-index"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p></div><div class="pcc-lighting-copy"><h2>${htmlEscape(t(chapter.title))}</h2><p class="pcc-lighting-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-lighting-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div>${lightingImage(chapter.image,t(chapter.title))}</article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
    return `<section class="pcc-lighting-opening"><div class="pcc-lighting-opening-copy"><span>ENERGY / CONTROL / LIGHT</span><h2>${heading('introduction')}</h2><p>${htmlEscape(t(page.lead))}</p><div class="pcc-lighting-circuit" aria-hidden="true"><b>${LANG==='zh'?'电源':'POWER'}</b><i></i><b>${LANG==='zh'?'保护':'PROTECT'}</b><i></i><b>${LANG==='zh'?'控制':'CONTROL'}</b><i></i><b>${LANG==='zh'?'灯具':'LAMP'}</b></div></div>${lightingImage(page.images.range,`${item} ${LANG==='zh'?'汽车照明':'vehicle lighting'}`,'pcc-lighting-opening-media')}</section><section class="pcc-lighting-sequence">${chapters}</section><section class="pcc-rich-section pcc-rich-faq pcc-lighting-faq"><header class="pcc-rich-heading"><h2>${heading('faq')}</h2></header><div class="pcc-faq-grid">${faq}</div></section><details class="pcc-media-credits"><summary>${htmlEscape(t(page.creditHeading))}</summary><ul>${credits}</ul></details>`;
  }
  if(page.layout==='trailer-coupling-route'){
    const trailerImage=(src,alt,className='')=>`<figure class="pcc-trailer-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1400" height="960" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-trailer-chapter pcc-trailer-chapter-${index+1}"><header class="pcc-trailer-heading"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p><h2>${htmlEscape(t(chapter.title))}</h2></header><div class="pcc-trailer-copy"><p class="pcc-trailer-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-trailer-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div>${trailerImage(chapter.image,t(chapter.title))}</article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
    return `<section class="pcc-trailer-opening"><div class="pcc-trailer-opening-copy"><span>TOW / COUPLE / DISTRIBUTE / CONTROL</span><h2>${heading('introduction')}</h2><p>${htmlEscape(t(page.lead))}</p><div class="pcc-trailer-route" aria-hidden="true"><b>${LANG==='zh'?'牵引车':'TOW'}</b><i></i><b>${LANG==='zh'?'接口':'COUPLING'}</b><i></i><b>${LANG==='zh'?'底盘':'CHASSIS'}</b><i></i><b>${LANG==='zh'?'负载':'LOADS'}</b></div></div>${trailerImage(page.images.range,`${item} ${LANG==='zh'?'牵引与拖车场景':'towing and trailer context'}`,'pcc-trailer-opening-media')}</section><section class="pcc-trailer-routebook">${chapters}</section><section class="pcc-rich-section pcc-rich-faq pcc-trailer-faq"><header class="pcc-rich-heading"><h2>${heading('faq')}</h2></header><div class="pcc-faq-grid">${faq}</div></section><details class="pcc-media-credits"><summary>${htmlEscape(t(page.creditHeading))}</summary><ul>${credits}</ul></details>`;
  }
  if(page.layout==='solar-energy-flow'){
    ...
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-solar-chapter pcc-solar-chapter-${index+1}"><div class="pcc-solar-meta"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p></div>${solarImage(chapter.image,t(chapter.title))}<div class="pcc-solar-copy"><h2>${htmlEscape(t(chapter.title))}</h2><p class="pcc-solar-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-solar-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div></article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
    return `<section class="pcc-solar-opening"><div class="pcc-solar-opening-copy"><span>MODULE / STRING / BRANCH / INVERTER</span><h2>${heading('introduction')}</h2><p>${htmlEscape(t(page.lead))}</p><div class="pcc-solar-route"><b>DC+</b><i></i><b>${LANG==='zh'?'组串':'STRING'}</b><i></i><b>${LANG==='zh'?'汇流':'COMBINE'}</b><i></i><b>DC−</b></div></div>${solarImage(page.images.range,`${item} ${LANG==='zh'?'光伏连接器':'PV connector'}`,'pcc-solar-opening-media')}</section><section class="pcc-solar-flow">${chapters}</section><section class="pcc-rich-section pcc-rich-faq pcc-solar-faq"><header class="pcc-rich-heading"><h2>${heading('faq')}</h2></header><div class="pcc-faq-grid">${faq}</div></section><details class="pcc-media-credits"><summary>${htmlEscape(t(page.creditHeading))}</summary><ul>${credits}</ul></details>`;
  }
  if(page.layout==='medical-clinical-atlas'){
    const medicalImage=(src,alt,className='')=>`<figure class="pcc-medical-media ${className}"><img src="${htmlEscape(src)}" alt="${htmlEscape(alt)}" width="1400" height="960" loading="lazy" decoding="async"></figure>`;
    const chapters=(page.chapters||[]).map((chapter,index)=>`<article class="pcc-medical-chapter pcc-medical-chapter-${index+1}"><header class="pcc-medical-heading"><span>${String(index+1).padStart(2,'0')}</span><p>${htmlEscape(t(chapter.kicker))}</p><h2>${htmlEscape(t(chapter.title))}</h2></header>${medicalImage(chapter.image,t(chapter.title))}<div class="pcc-medical-copy"><p class="pcc-medical-summary">${htmlEscape(t(chapter.copy))}</p><div class="pcc-medical-points">${(chapter.points||[]).map(point=>`<section><h3>${htmlEscape(t(point.title))}</h3><p>${htmlEscape(t(point.copy))}</p></section>`).join('')}</div></div></article>`).join('');
    const faq=(page.faq||[]).map((entry,index)=>`<details${index===0?' open':''}><summary>${htmlEscape(t(entry.q))}</summary><p>${htmlEscape(t(entry.a))}</p></details>`).join('');
    const credits=(page.mediaCredits||[]).map(entry=>`<li><a href="${htmlEscape(entry.url)}" target="_blank" rel="noopener">${htmlEscape(entry.file)}</a><span>${htmlEscape(entry.author)} · ${htmlEscape(entry.license)}</span></li>`).join('');
    return `<section class="pcc-medical-opening"><div class="pcc-medical-opening-copy"><span>PATIENT / DEVICE / PROCESS / EVIDENCE</span><h2>${heading('introduction')}</h2><p>${htmlEscape(t(page.lead))}</p><div class="pcc-medical-spectrum"><b>${LANG==='zh'?'患者侧':'PATIENT SIDE'}</b><i></i><b>${LANG==='zh'?'设备侧':'DEVICE SIDE'}</b><i></i><b>${LANG==='zh'?'设备内部':'INTERNAL'}</b></div></div>${medicalImage(page.images.range,`${item} ${LANG==='zh'?'临床连接场景':'clinical connection context'}`,'pcc-medical-opening-media')}</section><section class="pcc-medical-atlas">${chapters}</section><section class="pcc-rich-section pcc-rich-faq pcc-medical-faq"><header class="pcc-rich-heading"><h2>${heading('faq')}</h2></header><div class="pcc-faq-grid">${faq}</div></section><details class="pcc-media-credits"><summary>${htmlEscape(t(page.creditHeading))}</summary><ul>${credits}</ul></details>`;
  }
