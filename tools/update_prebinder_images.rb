...
SECTION_IMAGES = {
  ...
  "custom-harness-01" => {
    "variants" => %W[#{PREFIX}/industrial-equipment/control-panel.jpg #{PREFIX}/industrial-equipment/factory-robot.jpg #{PREFIX}/industrial-equipment/pcb-inspection.jpg #{PREFIX}/industrial-equipment/sealed-connector.jpg #{PREFIX}/industrial-equipment/automation-lab.jpg #{PREFIX}/industrial-equipment/cnc-machine.jpg],
    "materials" => %W[#{PREFIX}/industrial-equipment/copper-wire.jpg #{PREFIX}/industrial-equipment/cable-insulation.jpg #{PREFIX}/industrial-equipment/cable-bundle.jpg #{PREFIX}/industrial-equipment/splice-connectors.jpg],
    "solutions" => %W[#{PREFIX}/industrial-equipment-refresh/engineering-blueprint.jpg #{PREFIX}/industrial-equipment/connector-shelf.jpg #{PREFIX}/industrial-equipment-refresh/material-organization.jpg #{PREFIX}/industrial-equipment-refresh/factory-release.jpg],
    "applications" => %W[#{PREFIX}/industrial-equipment-refresh/automation-controls.jpg #{PREFIX}/industrial-equipment/cnc-operation.jpg #{PREFIX}/industrial-equipment/packaging-line.jpg #{PREFIX}/industrial-equipment-refresh/warehouse-automation.jpg #{PREFIX}/industrial-equipment/water-treatment.jpg #{PREFIX}/industrial-equipment/test-measurement.jpg],
    "process" => %W[#{PREFIX}/industrial-equipment/panel-testing.jpg #{PREFIX}/industrial-equipment/electrician-review.jpg #{PREFIX}/industrial-equipment/component-bins.jpg #{PREFIX}/industrial-equipment/machine-build.jpg #{PREFIX}/industrial-equipment-refresh/electrical-validation.jpg #{PREFIX}/industrial-equipment-refresh/cnc-production.jpg],
    "reliability" => %W[#{PREFIX}/industrial-equipment/reliability-dust-oil.jpg #{PREFIX}/industrial-equipment/reliability-vibration.jpg #{PREFIX}/industrial-equipment/reliability-temperature.jpg #{PREFIX}/industrial-equipment-refresh/interface-electronics.jpg],
    "benefits" => %W[#{PREFIX}/industrial-equipment-refresh/equipment-maintenance.jpg #{PREFIX}/industrial-equipment/benefit-maintenance.jpg #{PREFIX}/industrial-equipment-refresh/production-quality.jpg #{PREFIX}/industrial-equipment/metal-parts.jpg]
  },
  "custom-harness-03" => {
  ...
  "custom-harness-04" => {
    "variants" => %W[#{PREFIX}/industrial-equipment/test-measurement.jpg #{PREFIX}/industrial-equipment/cable-bundle.jpg #{PREFIX}/industrial-equipment/pcb-inspection.jpg #{PREFIX}/industrial-equipment/sealed-connector.jpg #{PREFIX}/industrial-equipment/control-panel.jpg #{PREFIX}/industrial-equipment/automation-lab.jpg],
    "materials" => %W[#{PREFIX}/industrial-equipment/copper-wire.jpg #{PREFIX}/instrument-refresh/shielded-signal-path.jpg #{PREFIX}/industrial-equipment/cable-insulation.jpg #{PREFIX}/industrial-equipment/splice-connectors.jpg],
    "solutions" => %W[#{PREFIX}/industrial-equipment/electrician-review.jpg #{PREFIX}/industrial-equipment/connector-shelf.jpg #{PREFIX}/industrial-equipment/panel-testing.jpg #{PREFIX}/industrial-equipment/component-bins.jpg],
    "applications" => %W[#{PREFIX}/instrument-refresh/oscilloscope-lab.jpg #{PREFIX}/industrial-equipment/packaging-line.jpg #{PREFIX}/industrial-equipment/water-treatment.jpg #{PREFIX}/industrial-equipment/cnc-operation.jpg #{PREFIX}/instrument-refresh/instrument-technician.jpg #{PREFIX}/industrial-equipment/factory-robot.jpg],
    "process" => %W[#{PREFIX}/instrument-refresh/precision-measurement.jpg #{PREFIX}/instrument-refresh/dimensional-definition.jpg #{PREFIX}/instrument-refresh/process-gauges.jpg #{PREFIX}/industrial-equipment/machine-build.jpg #{PREFIX}/instrument-refresh/signal-oscilloscope.jpg #{PREFIX}/instrument-refresh/pressure-instrumentation.jpg],
    "reliability" => %W[#{PREFIX}/instrument-refresh/industrial-meter.jpg #{PREFIX}/instrument-refresh/process-equipment.jpg #{PREFIX}/industrial-equipment/reliability-temperature.jpg #{PREFIX}/industrial-equipment/reliability-vibration.jpg],
    "benefits" => %W[#{PREFIX}/instrument-refresh/system-gauge.jpg #{PREFIX}/industrial-equipment/benefit-maintenance.jpg #{PREFIX}/industrial-equipment/factory-line.jpg #{PREFIX}/instrument-refresh/instrument-maintenance.jpg]
  },
  "custom-harness-05" => {
    "variants" => %W[#{PREFIX}/appliance/circuit-board-technician.jpg #{PREFIX}/appliance/heating-element.jpg #{PREFIX}/appliance/electric-motor.jpg #{PREFIX}/appliance/appliance-technician.jpg #{PREFIX}/appliance/pcb-repair.jpg #{PREFIX}/industrial-equipment/cable-bundle.jpg],
    "materials" => %W[#{PREFIX}/industrial-equipment/copper-wire.jpg #{PREFIX}/appliance-refresh/heated-cooking.jpg #{PREFIX}/industrial-equipment/splice-connectors.jpg #{PREFIX}/appliance-refresh/circuit-board-service.jpg],
    "solutions" => %W[#{PREFIX}/appliance-refresh/electronics-training.jpg #{PREFIX}/appliance-refresh/aircon-workshop.jpg #{PREFIX}/appliance-refresh/commercial-kitchen.jpg #{PREFIX}/industrial-equipment/connector-shelf.jpg],
    "applications" => %W[#{PREFIX}/appliance-refresh/commercial-oven.jpg #{PREFIX}/appliance-refresh/cooling-maintenance.jpg #{PREFIX}/appliance-refresh/outdoor-hvac.jpg #{PREFIX}/industrial-equipment/water-treatment.jpg #{PREFIX}/industrial-equipment/packaging-line.jpg #{PREFIX}/appliance-refresh/domestic-appliances.jpg],
    "process" => %W[#{PREFIX}/appliance-refresh/equipment-layout.jpg #{PREFIX}/appliance-refresh/stainless-kitchen.jpg #{PREFIX}/appliance-refresh/aircon-repair.jpg #{PREFIX}/industrial-equipment/machine-build.jpg #{PREFIX}/appliance-refresh/hvac-controls.jpg #{PREFIX}/industrial-equipment/factory-line.jpg],
    "reliability" => %W[#{PREFIX}/appliance-refresh/oven-operation.jpg #{PREFIX}/appliance-refresh/restaurant-kitchen.jpg #{PREFIX}/industrial-equipment/reliability-vibration.jpg #{PREFIX}/appliance-refresh/professional-cooking.jpg],
    "benefits" => %W[#{PREFIX}/appliance-refresh/kitchen-preparation.jpg #{PREFIX}/industrial-equipment/benefit-maintenance.jpg #{PREFIX}/appliance-refresh/pizza-oven-line.jpg #{PREFIX}/appliance-refresh/water-pump-service.jpg]
  },
  "custom-harness-02" => {
